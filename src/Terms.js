...
const Terms = () => {
    ...
    <Row>
      <Col>
        ...
        You agree not to encrypt/decrypt material containing: violation the law, infringing copyright, infringing the rights of ethnic groups, or promoting racism, Nazism, or promoting hatred (racial, religious, political etc.), 
        incite to violations of law, terrorism, referring to child pornography, or otherwise unsuitable material or activities.</p>
